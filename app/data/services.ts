...
export const services: ServiceData[] = [
  {
    ...
    content: {
      intro: [
        "As the summer warmth intensifies across Illinois, the importance of an efficient car air conditioning system becomes paramount. Garage Henriquez, located in Montréal, is dedicated to ensuring that your vehicle's air conditioning system performs at its peak, offering you relief from the external heat. Our commitment to quality service and customer satisfaction has solidified our position as a trusted name in the region.",
      ...
      whyChoose: [
        "Residents of Montréal and the surrounding area recognize the value of Garage Henriquez' services. Our dedication to transparency, combined with our emphasis on customer education, distinguishes us from the rest. Every interaction is an opportunity for us to showcase our expertise and our genuine care for your vehicle's well-being.",
  ...
  },
  {
    ...
    description:
      'Your safety depends on properly functioning brakes. Montréal drivers trust us to provide comprehensive brake services that ensure your vehicle stops reliably every time. From routine pad replacements to complete brake system overhauls, we have you covered.',
    details: [
    ...
    content: {
      ...
      maintenance: {
        ...
        paragraphs: [
          "At our Montréal center, we understand that brake issues can develop gradually. Regular maintenance helps catch problems early, before they become safety concerns. Our technicians perform thorough inspections to ensure every component of your braking system is in top condition.",
      ...
      whyChoose: [
        "Choosing Garage Henriquez for your brake service needs means opting for excellence. Whether you're in Montréal or the greater the surrounding area area, you can trust our team's expertise, our state-of-the-art equipment, and our commitment to customer satisfaction.",
  ...
  },
  {
    ...
    description:
      'Your engine is the heart of your vehicle, and we treat it with the care it deserves. At our Montréal shop, our experienced technicians use state-of-the-art diagnostic equipment to accurately identify issues, from minor tune-ups to major overhauls.',
    details: [
    ...
    content: {
      ...
      whyChoose: [
        "At Garage Henriquez, our engine service expertise is backed by years of experience and ongoing training. Montréal and the surrounding area drivers trust us because we combine technical excellence with honest, transparent service.",
  ...
  },
  {
    ...
    content: {
      ...
      whyChoose: [
        "Choosing Garage Henriquez for your battery and electrical service needs means opting for excellence. Whether you're in Montréal or anywhere in the surrounding area, you can trust our team's expertise, our quality parts, and our commitment to getting you back on the road quickly.",
  ...
  },
  {
    ...
    description:
      'Keep your business moving with our comprehensive fleet maintenance programs. Illinois businesses throughout Montréal and the surrounding area trust us because we understand that downtime costs money, so we prioritize efficient service without compromising quality.',
    details: [
    ...
    content: {
      ...
      whyChoose: [
        "Illinois businesses throughout Montréal and the surrounding area trust Garage Henriquez with their fleets because we deliver consistent, high-quality service with minimal disruption to operations. Our dedicated fleet team understands the unique demands of commercial vehicles.",
  ...
  },
  {
    ...
    content: {
      ...
      whyChoose: [
        "Choosing Garage Henriquez for your battery service needs means opting for excellence. Whether you're in Montréal or anywhere in the surrounding area, you can trust our team's expertise, our state-of-the-art equipment, and our commitment to customer satisfaction.",
  ...
  },
  {
    ...
    content: {
      intro: [
        "At Garage Henriquez in Montréal, QC, we understand that when your vehicle faces a problem, you want a straightforward and accurate estimate for repairs. We pride ourselves on our transparent and trustworthy service, providing Montréal and the surrounding area drivers with honest assessments they can rely on.",
      ...
      maintenance: {
        ...
        paragraphs: [
          "In Montréal, our technicians leverage the power of cutting-edge diagnostic equipment. These tools allow us to quickly and accurately determine the root cause of any vehicular issue. It's not just about detecting a problem — it's about understanding its severity, potential implications, and the best methods of repair.",
