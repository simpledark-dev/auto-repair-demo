...
export async function generateMetadata({
  ...
  const description = `Expert ${vehicle.name} service and repair in Montréal, QC. Garage Henriquez provides quality maintenance, diagnostics, and repairs for all ${vehicle.name} models.`;
  return {
    title: `${vehicle.name} Service & Repair - Garage Henriquez | Montréal, QC`,
    description,
    alternates: {
    ...
    openGraph: {
      url: canonicalUrl,
      title: `${vehicle.name} Service & Repair | Garage Henriquez`,
      description,
    },
    twitter: {
...
export default async function VehicleDetailPage({
  ...
  const vehicleJsonLd = {
    ...
    description: `Maintenance and repair for all ${vehicle.name} models in Montréal, Québec.`,
