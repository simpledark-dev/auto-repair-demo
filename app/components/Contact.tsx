  ...
  const contactInfo = [
    {
      ...
      value: '2001 Rue Centre',
      value2: 'Montréal, QC H3K 1J1',
      link: 'https://maps.google.com/?q=2001+Rue+Centre,+Montreal,+QC+H3K+1J1',
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      value: 'garagehenriquez@gmail.com',
      link: 'mailto:garagehenriquez@gmail.com',
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl ring-1 ring-black/5 h-full min-h-[400px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2787.8!2d-73.5705!3d45.4737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cc91a3b1e5f5f5f%3A0x5f5f5f5f5f5f5f5f!2s2001+Rue+Centre%2C+Montr%C3%A9al%2C+QC+H3K+1J1!5e0!3m2!1sfr!2sca!4v1234567890123!5m2!1sfr!2sca"
                width="100%"
                height="100%"
                ...
                title="Garage Henriquez Location"
