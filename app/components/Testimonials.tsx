...
const testimonials = [
  {
    ...
    role: 'Local Guide',
    quote:
      'Unbeatable service with very fair and honest pricing. The team took great care of all the issues with my girlfriend\'s Fiat and made the whole process easy and stress-free. Highly recommend. I\'ll definitely be referring clients to them any chance I get. Thanks again, guys.',
    rating: 5,
  },
  {
    name: 'Alexandre Gaudreau',
    role: 'Local Guide',
    quote:
      'Good experience, took me in for an appointment before the holidays quickly and did a good job. Great garage in the neighborhood.',
    rating: 5,
  },
  {
    ...
    role: 'Local Guide',
    quote:
      'The need for a simple brake light replacement led me to this very unusual garage littered with nostalgic collectibles - and some of the friendliest mechanics I have ever met! Fast and efficient too!!',
    rating: 5,
  },
  {
    name: 'Peter Belanger',
    role: 'Montréal Resident',
    quote:
      'Been dealing with Juan for over 10 years now. They are the most friendliest and honest mechanics I\'ve ever dealt with in my life. If they can\'t do the job they\'ll even refer you to someone that can…. Nothing but amazing things to say about this garage!',
    rating: 5,
  },
];
...
export default function Testimonials() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 md:py-24 bg-[var(--qah-primary)] opacity-0 overflow-hidden"
    >
      {/* Decorative Elements */}
      <div className="absolute top-10 right-0 w-96 h-96 bg-white/15 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[var(--qah-accent)]/30 rounded-full blur-3xl" />
